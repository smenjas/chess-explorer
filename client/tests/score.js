...
tests['Score.notateMove() works.'] = () => {
    const tests = [
        [['WK', 'e1', 'd1', '', false, false, ''], 'Kd1'],
        [['WK', 'e1', 'c1', '', false, false, ''], '0-0-0'],
        [['WK', 'e1', 'g1', '', false, false, ''], '0-0'],
        [['BK', 'e8', 'c8', '', false, false, ''], '0-0-0'],
        [['BK', 'e8', 'g8', '', false, false, ''], '0-0'],
        [['BK', 'e8', 'e7', '', false, false, ''], 'Ke7'],
        [['BP', 'h7', 'g6', 'WP', false, false, ''], 'hxg6'],
        [['WN', 'g1', 'f3', '', false, false, ''], 'Nf3'],
        [['BB', 'f8', 'b4', '', false, false, ''], 'Bb4'],
        [['BN', 'b8', 'd7', '', false, false, 'b'], 'Nbd7'],
    ];
